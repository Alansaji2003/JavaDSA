...
public class ObjectEquality {
    //objects compared using equals() method, primitives compared using ==
...
//        Integer.valueOf(128);
        ...
        //in java, numbers from -128 to 127 are pooled inside Integer class, so the object reference of 127
        //or any other number within that range which are not instantiated with new operator will have the same
        //memory location or hash codes, so it's better to compare objects with equals method
    }
}
